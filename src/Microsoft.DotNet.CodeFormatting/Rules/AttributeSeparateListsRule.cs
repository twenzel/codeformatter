...
{
    [SyntaxRule(Name = Name, Description = Description, Order = GlobalSemanticRuleOrder.AttributeSeparateListsRule)]
    internal sealed class AttributeSeparateListsRule : CSharpOnlyFormattingRule, ISyntaxFormattingRule
    {
        internal const string Name = "AttributeSeparateLists";
        internal const string Description = "Ensure every attributes is on a new line";
